...
function webtable() {  
	...
	var tooltip = {		
		formatter: function(){
			var tiptext;
			switch (this.y){
				case 25:tiptext="熟练掌握各种HTML标签的使用，<br />掌握HTML5语义标签、Web SQL的使用。";
				break;
				case 22:tiptext="熟练掌握CSS盒子模型、CSS3动画进行页面布局。";
				break;
				case 18:tiptext="能够熟练的使用DOM、BOM等<br />完成需要的页面效果编程。";
				break;
				case 15:tiptext="掌握使用jQuery完成页面浏览器兼容问题";
				break;
				case 10:tiptext="掌握使用Bootstrap完成响应式页面开发";
				break;
				case 6:tiptext="能够使用jQuery Mobile开发移动端页面开发";
				break;
				case 3:tiptext="理解JSON格式数据的书写<br />及使用JavaScript进行解析";
				break;
				case 1:tiptext="理解使用AJAX完成页面异步更新";
				break;
			};
			...
			var tooltip = {
				formatter: function(){
					...
					switch (this.y){
						...
						break;
						case 4.5:tiptext="熟练掌握使用port security<br />限制网络中设备的接入";
						break;
						case 5.8:tiptext="熟练掌握dhcp欺骗攻击的防御";
						break;
						...
						break;
						case 2.8:tiptext="掌握阿卡特IP电话的配置、排错、管理；<br />掌握华为IP话机的管理；<br />掌握思科、POLYCOM视频会议的原理和管理";
						break;
