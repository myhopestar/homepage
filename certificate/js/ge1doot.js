...
ge1doot.Screen = function(setup) {
	...
	false); ! this.setup.resize && this.resize()
}
ge1doot.Pointer = function(setup) {
	...
	if (window.navigator.msPointerEnabled) {
		...
		this.elem.addEventListener("MSPointerDown",
		function(e) {
		...
		false);
		this.elem.addEventListener("MSPointerOut",
		function(e) {
			if (e.pointerType == e.MSPOINTER_TYPE_TOUCH) {
				nContact--
			}
		...
		false);
		this.elem.addEventListener("MSGestureHold",
		function(e) {
			e.preventDefault()
		},
		false);
		this.elem.addEventListener("MSGestureChange",
		function(e) {
			if (nContact > 1) {
	...
	if (window.addEventListener) this.elem.addEventListener('DOMMouseScroll',
	function(e) {
		if (e.preventDefault) e.preventDefault();
