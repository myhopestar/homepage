...
ge1doot.transform3D.Triangle.prototype.draw = function() {
	if (this.p0.visible || this.p1.visible || this.p2.visible) {
		...
		this.ctx.transform( - (this.p0.ty * t0 - t5 + t2 + this.pmy * this.p0.X) / this.d, (t6 + this.p0.ty * t1 - t4 - this.pmy * this.p0.Y) / this.d, (this.p0.tx * t0 - t3 + t7 + this.pmx * this.p0.X) / this.d, -(t8 + this.p0.tx * t1 - t9 - this.pmx * this.p0.Y) / this.d, (this.p0.tx * (t2 - t5) + this.p0.ty * (t3 - t7) + this.pxy * this.p0.X) / this.d, (this.p0.tx * (t4 - t6) + this.p0.ty * (t8 - t9) + this.pxy * this.p0.Y) / this.d);
